...
from paths import ELFILI_FINAL, ELFILI_FINAL_V2, NOLI_FINAL, NOLI_FINAL_V2, PHASE_D6_LOG_ELFILI, PHASE_D6_LOG_NOLI, PHASE_D6_PROPOSAL, PHASE_D6_SUMMARY
...
OUTPUTS = {
    'noli': NOLI_FINAL_V2,
    'elfili': ELFILI_FINAL_V2
}
LOGS = {
    'noli': PHASE_D6_LOG_NOLI,
    'elfili': PHASE_D6_LOG_ELFILI
}
PROPOSAL_FILE = PHASE_D6_PROPOSAL
SUMMARY_FILE = PHASE_D6_SUMMARY
