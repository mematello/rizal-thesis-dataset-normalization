...
from paths import ELFILI_CHAPTER_SENTENCES_MODERNIZED_V2, ELFILI_CHAPTER_SENTENCES_TITLES_FIXED, ELFILI_CHAPTER_TITLES_NORMALIZED, NOLI_CHAPTER_SENTENCES_MODERNIZED_V2, NOLI_CHAPTER_SENTENCES_TITLES_FIXED, NOLI_CHAPTER_TITLES_NORMALIZED, PHASE_T_TITLE_LOG_ELFILI, PHASE_T_TITLE_LOG_NOLI, PHASE_T_TITLE_SUMMARY_ELFILI, PHASE_T_TITLE_SUMMARY_NOLI


# Input/Output Files
INPUT_FILES = {
    'elfili': ELFILI_CHAPTER_SENTENCES_MODERNIZED_V2,
    'noli': NOLI_CHAPTER_SENTENCES_MODERNIZED_V2
}
OUTPUT_FILES = {
    'elfili': ELFILI_CHAPTER_SENTENCES_TITLES_FIXED,
    'noli': NOLI_CHAPTER_SENTENCES_TITLES_FIXED
}
LOG_FILES = {
    'elfili': PHASE_T_TITLE_LOG_ELFILI,
    'noli': PHASE_T_TITLE_LOG_NOLI
}
NORMALIZED_TITLES_FILES = {
    'elfili': ELFILI_CHAPTER_TITLES_NORMALIZED,
    'noli': NOLI_CHAPTER_TITLES_NORMALIZED
}
SUMMARY_FILES = {
    'elfili': PHASE_T_TITLE_SUMMARY_ELFILI,
    'noli': PHASE_T_TITLE_SUMMARY_NOLI
}
