...
from paths import ELFILI_CHAPTER_SENTENCES_MODERNIZED, ELFILI_CHAPTER_SENTENCES_MODERNIZED_V2, NOLI_CHAPTER_SENTENCES_MODERNIZED, NOLI_CHAPTER_SENTENCES_MODERNIZED_V2, PHASE_D2_CANDIDATES, PHASE_D2_LOG_ELFILI, PHASE_D2_LOG_NOLI, PHASE_D2_SUMMARY_ELFILI, PHASE_D2_SUMMARY_NOLI, PHASE_D_MAPPING_MASTER, PHASE_D_MAPPING_MASTER_V2


# Configuration
INPUT_FILES = {
    'elfili': ELFILI_CHAPTER_SENTENCES_MODERNIZED,
    'noli': NOLI_CHAPTER_SENTENCES_MODERNIZED
}
MAPPING_MASTER = PHASE_D_MAPPING_MASTER

OUTPUT_MAPPING = PHASE_D_MAPPING_MASTER_V2
OUTPUT_FILES = {
    'elfili': ELFILI_CHAPTER_SENTENCES_MODERNIZED_V2,
    'noli': NOLI_CHAPTER_SENTENCES_MODERNIZED_V2
}
OUTPUT_LOGS = {
    'elfili': PHASE_D2_LOG_ELFILI,
    'noli': PHASE_D2_LOG_NOLI
}
OUTPUT_SUMMARIES = {
    'elfili': PHASE_D2_SUMMARY_ELFILI,
    'noli': PHASE_D2_SUMMARY_NOLI
}
CANDIDATES_FILE = PHASE_D2_CANDIDATES
