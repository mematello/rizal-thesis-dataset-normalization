...
from paths import ELFILI_EXTRACTION_NORMALIZED, LEXICON_CANDIDATES, NOLI_EXTRACTION_NORMALIZED


FILES = [
    ELFILI_EXTRACTION_NORMALIZED,
    NOLI_EXTRACTION_NORMALIZED
]

OUTPUT_CANDIDATES = LEXICON_CANDIDATES
