...
from paths import ALL_TOKENS_INVENTORY, CORPUS_PROFILE, NOLI_FINAL_V2, PROTECTED_TERMS


# Configuration
INPUT_FILE = NOLI_FINAL_V2
CORPUS_PROFILE_FILE = CORPUS_PROFILE
ALL_TOKENS_FILE = ALL_TOKENS_INVENTORY
