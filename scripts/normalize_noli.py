...
from paths import NOLI_EXTRACTION_CSV, NOLI_EXTRACTION_NORMALIZED, NOLI_NORMALIZED_ORTHO_TXT, NORMALIZATION_LOG_NOLI_TXT


INPUT_CSV = NOLI_EXTRACTION_CSV
OUTPUT_CSV = NOLI_EXTRACTION_NORMALIZED
OUTPUT_TXT = NOLI_NORMALIZED_ORTHO_TXT
LOG_FILE = NORMALIZATION_LOG_NOLI_TXT
