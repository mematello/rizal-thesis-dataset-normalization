...
from paths import CHANGE_LOG_CSV, MAPPING_PROPOSAL, NOLI_FINAL_V2, NORMALIZATION_SUMMARY_TXT


# Configuration
MAPPING_FILE = MAPPING_PROPOSAL
INPUT_CSV = NOLI_FINAL_V2
OUTPUT_CSV = "noli_chapter_sentences_NORMALIZED.csv"
CHANGELOG_FILE = CHANGE_LOG_CSV
SUMMARY_FILE = NORMALIZATION_SUMMARY_TXT
