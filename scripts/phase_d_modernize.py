...
def main():
    ...
    # 4 datasets
    tasks = [
        (ELFILI_EXTRACTION_NORMALIZED, ELFILI_EXTRACTION_MODERNIZED, 'elfili_paragraphs'),
        (ELFILI_CHAPTER_SENTENCES, ELFILI_CHAPTER_SENTENCES_MODERNIZED, 'elfili_sentences'),
        (NOLI_EXTRACTION_NORMALIZED, NOLI_EXTRACTION_MODERNIZED, 'noli_paragraphs'),
        (NOLI_CHAPTER_SENTENCES, NOLI_CHAPTER_SENTENCES_MODERNIZED, 'noli_sentences')
    ]
    ...
    for fname, logs in [(PHASE_D_LOG_ELFILI, logs_elfili), (PHASE_D_LOG_NOLI, logs_noli)]:
