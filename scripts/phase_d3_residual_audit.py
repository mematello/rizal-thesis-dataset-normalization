...
from paths import ELFILI_CHAPTER_SENTENCES_MODERNIZED_V2, NOLI_CHAPTER_SENTENCES_MODERNIZED_V2, RESIDUAL_C_AUDIT_SUMMARY, RESIDUAL_C_CLASSIFIED, RESIDUAL_C_INVENTORY
...
OUTPUT_INVENTORY = RESIDUAL_C_INVENTORY
OUTPUT_CLASSIFIED = RESIDUAL_C_CLASSIFIED
OUTPUT_SUMMARY = RESIDUAL_C_AUDIT_SUMMARY
