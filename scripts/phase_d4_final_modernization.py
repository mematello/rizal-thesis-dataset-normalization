...
from paths import ELFILI_CHAPTER_SENTENCES_TITLES_FIXED_V2, ELFILI_FINAL, NOLI_CHAPTER_SENTENCES_TITLES_FIXED_V3, NOLI_FINAL, PHASE_D4_LOG_ELFILI, PHASE_D4_LOG_NOLI, PHASE_D4_SUMMARY


# Input/Output Config
INPUTS = {
    'noli': NOLI_CHAPTER_SENTENCES_TITLES_FIXED_V3,
...
LOGS = {
    'noli': PHASE_D4_LOG_NOLI,
    'elfili': PHASE_D4_LOG_ELFILI
}
SUMMARY_FILE = PHASE_D4_SUMMARY
