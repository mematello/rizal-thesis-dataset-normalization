...
from paths import NOLI_CHAPTER_SENTENCES_TITLES_FIXED_V2, NOLI_CHAPTER_SENTENCES_TITLES_FIXED_V3, PHASE_T3_NOLI_CORRECTION_SUMMARY


INPUT_FILE = NOLI_CHAPTER_SENTENCES_TITLES_FIXED_V2
OUTPUT_FILE = NOLI_CHAPTER_SENTENCES_TITLES_FIXED_V3
SUMMARY_FILE = PHASE_T3_NOLI_CORRECTION_SUMMARY
