...
from paths import ALL_TOKENS_INVENTORY, HUMAN_REVIEW_LIST, PROTECTED_TERMS, RESIDUAL_CANDIDATES


# Configuration
INVENTORY_FILE = ALL_TOKENS_INVENTORY
PROTECTED_TERMS_FILE = PROTECTED_TERMS
CANDIDATES_FILE = RESIDUAL_CANDIDATES
REVIEW_FILE = HUMAN_REVIEW_LIST
