...
from paths import ELFILI_EXTRACTION_CSV, ELFILI_EXTRACTION_NORMALIZED, ELFILI_NORMALIZED_ORTHO_TXT


INPUT_CSV = ELFILI_EXTRACTION_CSV
OUTPUT_CSV = ELFILI_EXTRACTION_NORMALIZED
