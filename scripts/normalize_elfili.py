...
from paths import ELFILI_EXTRACTED_RAW, ELFILI_NORMALIZED_ORTHO_TXT, ELFILI_RAW_HTML, NORMALIZATION_LOG_TXT
...
# --- Configuration ---
INPUT_FILE = ELFILI_RAW_HTML
OUTPUT_RAW = ELFILI_EXTRACTED_RAW
OUTPUT_NORMALIZED = ELFILI_NORMALIZED_ORTHO_TXT
LOG_FILE = NORMALIZATION_LOG_TXT
