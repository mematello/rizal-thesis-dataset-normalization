...
from paths import ELFILI_EXTRACTION_NORMALIZED, ELFILI_NORMALIZED_ORTHO_TXT


INPUT_CSV = ELFILI_EXTRACTION_NORMALIZED
OUTPUT_CSV = ELFILI_EXTRACTION_NORMALIZED # Overwriting as requested/implied by "Updated:" deliverables
INPUT_TXT = ELFILI_NORMALIZED_ORTHO_TXT
OUTPUT_TXT = ELFILI_NORMALIZED_ORTHO_TXT
